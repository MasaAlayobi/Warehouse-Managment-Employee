...
class DetailsPurchaseOrderModel {
  ...
  factory DetailsPurchaseOrderModel.fromMap(Map<dynamic, dynamic> map) {
    return DetailsPurchaseOrderModel(
      ...
      warehouse: map['warehouse'] != null ? WarehouseInfoModel.fromMap(map['warehouse'] as Map<dynamic,dynamic>) : null,
