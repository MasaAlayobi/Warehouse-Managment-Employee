...
class WidgetUpdateSale extends StatelessWidget {
   WidgetUpdateSale({super.key, required this.purchasingPrice, required this.salePrice, required this.start_price,this.readOnly});
   bool? readOnly;
